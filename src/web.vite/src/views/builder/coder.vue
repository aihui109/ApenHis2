<template>
  <div class="builder-container">
    <vol-box ref="add" :width="850" :height="450" title="新建配置信息" padding="10px" v-model="addModel">
      ...
      <div class="addModel" style="padding-right: 30px">
        <vol-form ref="addForm" :formRules="addOptions" :formFields="layOutOptins.fields">
        </vol-form>
      </div>
      <template #footer>
        <div>
          <el-button type="primary" size="small" @click="add"><i class="el-icon-plus"></i> 确 定</el-button>
        </div>
      </template>
    </vol-box>
        ...
        <el-scrollbar style="height: 100%">
          <div class="coder-container">
            <div class="coder-item" style="padding-top: 7px">
              ...
              <div class="config">
                <vol-form :label-width="90" ref="form" :formRules="layOutOptins.options"
                  :formFields="layOutOptins.fields"></vol-form>
              </div>
            </div>
            <el-alert type="warning" :closable="false">
            ...
            <div class="coder-item">
              <VolHeader icon="md-podium" style="border-bottom: 0" text="表结构">
                ...
                <div class="action">
                  <span style="color: rgb(23, 156, 216)" class="ivu-icon ivu-icon-ios-folder"
              ...
              <div class="grid-container" style="padding-bottom: 20px">
                <vol-table ref="table" :paginationHide="true" :tableData="data" :height="tableHeight"
                  :columns="layOutOptins.columns" :color="false" :index="true" :allowEmpty="true"
  ...
  methods: {
    ...
    ceateVuePage(isApp) {
      this.validateTableInfo(() => {
        ...
        let url = `/api/builder/createVuePage?vuePath=${vuePath}&vite=1&v3=1&app=${isApp ||
          0}`;
