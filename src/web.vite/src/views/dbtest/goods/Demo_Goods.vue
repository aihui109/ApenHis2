...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormFields = ref({"GoodsName":"","CatalogId":[],"GoodsCode":"","Price":"","Remark":"","Img":""});
            ...
            const columns = ref([{field:'GoodsId',title:'商品ID',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       {field:'GoodsName',title:'商品名称',type:'string',link:true,width:120,require:true,align:'left'},
                       {field:'CatalogId',title:'分类',type:'guid',bind:{ key:'分类级联',data:[]},width:70,align:'left'},
                       {field:'GoodsCode',title:'商品编号',type:'string',width:100,require:true,align:'left'},
                       {field:'Img',title:'商品图片',type:'img',width:70,align:'left'},
                       ...
                       {field:'Enable',title:'是否可用',type:'int',bind:{ key:'enable',data:[]},sort:true,width:90,align:'left'},
